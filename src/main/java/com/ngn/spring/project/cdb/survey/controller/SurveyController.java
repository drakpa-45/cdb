package com.ngn.spring.project.cdb.survey.controller;
...
public class SurveyController extends BaseController {
    ...
    @RequestMapping(value = "/surveyIndex")
    public String redirectToPage( ModelMap model) {
        ...
        model.addAttribute("fee_details", services.getFeesDetals("Survey"));
        ...
        model.addAttribute("undertaking", commonService.getundertaking("Survey_Registration"));

        return "/survey/registration/surveyIndex";
    }
    ...
    @ResponseBody
    @RequestMapping(value = "/survey/isMailUnique", method = RequestMethod.GET)
    ...
    public String saveSurvey(ArchitectDto dto,@RequestParam("files") MultipartFile[] files, HttpServletRequest request,ModelMap model) {
        ...
        try {
                ResponseMessage personal = services.saveSurvey(dto, user);
    ...
    @RequestMapping(value ={"/public_access/emptylayout/submitRenwalApplicationSurvey"}, method = RequestMethod.POST)
    public String submitRenwalApplication(ArchitectDto dto,@RequestParam("files") MultipartFile[] files,ModelMap model,HttpServletRequest request, HttpServletResponse response) {
        ...
        try{
            ResponseMessage personal=services.saveSurveyRenenwal(dto, loginDTO.getUserId());
            ArchitectDto resdto=(ArchitectDto)personal.getDto();
            if(personal.getStatus()==1){
    ...
    @PreAuthorize("isAuthenticated()")
      @RequestMapping(value ={"/public_access/emptylayout/submitsurveycancellation"}, method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/public_access/emptylayout/resubmissionsurvey")
    ...
    @RequestMapping(value ={"/public_access/emptylayout/surveyopenRejectedApplication"}, method = RequestMethod.GET)
    public String fetchRejectedAppDetails(HttpServletRequest request,String appNo,Model model) {
        ...
        model.addAttribute("fee_details", services.getFeesDetals("Survey"));
        model.addAttribute("registrationDetails", commonService.populateSurveyApplicantDetails(appNo));
        return "survey/rejection/survey_rejected_index";
    }
    ...
    @PreAuthorize("isAuthenticated()")
    @RequestMapping(value="/public_access/emptylayout/donwloadFilesSurvey",method = RequestMethod.GET)
    public String donwloadFiles(@RequestParam("type") String type,ArchitectDto dto,HttpServletRequest request,HttpServletResponse response,ModelMap model) {
        ...
        try{
            SurveyDocument doc = services.getDocumentDetailsByDocId(uploadDocId);
