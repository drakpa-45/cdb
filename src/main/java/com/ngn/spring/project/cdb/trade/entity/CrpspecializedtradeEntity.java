...
public class CrpspecializedtradeEntity implements Serializable {
    ...
    private String Permenant_village_serialNo;
    private String Sex;
    ...
    public void setFaxNo(String regFaxNo) {
        FaxNo = regFaxNo;
    }
    ...
    public void setCmnRegisteredDzongkhagId(String cmnRegisteredDzongkhagId) {
        CmnRegisteredDzongkhagId = cmnRegisteredDzongkhagId;
    }

    public String getPermenant_village_serialNo() {
        return Permenant_village_serialNo;
    }

    public void setPermenant_village_serialNo(String permenant_village_serialNo) {
        Permenant_village_serialNo = permenant_village_serialNo;
    }
    ...
    public void setCmnOwnershipTypeId(String cmnOwnershipTypeId) {
        CmnOwnershipTypeId = cmnOwnershipTypeId;
    }
    ...
    public void setShowInCertificate(Integer showInCertificate) {
        ShowInCertificate = showInCertificate;
    }
