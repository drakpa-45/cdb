 ...
 */
@Entity
@Table(name = "crpcontractorservicepaymentdetail")
public class ContractorServicePaymentDetail extends BaseModel implements Serializable {
    /*
    SELECT 	`Id`,
	`CrpContractorServicePaymentId`,
	`CmnCategoryId`,
    ...
    * */
    ...
    @Column(name = "Id")
    private String id;
    @Column(name = "CrpContractorServicePaymentId")
