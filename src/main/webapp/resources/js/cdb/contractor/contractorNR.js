...
function _baseURL() {
    return cdbGlobal.baseURL() + "/contractorNR";
}
...
var contractor = (function () {
    ...
    var cert = "<tr><td></td>" +
        "<td><input type='text' class='form-control' name='cAttachments[0].documentName'/> <input type='hidden' class='form-control aFor' name='cAttachments[0].attachmentFor' value='InSole'/></td>"+
