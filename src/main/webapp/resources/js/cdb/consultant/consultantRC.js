...
var consultantRC = (function () {
    ...
    function getConsultant() {
        if($('#consultantRenewalForm').length < 1){
            return;
        }
        $.ajax({
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        for (var i in equipments) {
                            ...
                            eqTr = eqTr +
                            "<tr>" +
                            "<td><input type='hidden' class='consultantEQid' name='equipments[0].id' value='"+equipments[i].id +"'/>" + equipments[i].equipmentName + "</td>" +
