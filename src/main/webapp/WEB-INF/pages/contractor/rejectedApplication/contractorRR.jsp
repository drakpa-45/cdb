                        ...
                        <form action="" method="post" class="" id="contractorRenewalForm" enctype="multipart/form-data">
                            <div class="nav-tabs-custom">
                                ...
                                <div class="tab-content border p-3 col-lg-12">
                                    ...
                                    <div class="tab-pane generalInformation" id="general_Information">
                                        <div class="div-actual">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-lg-6 col-md-6 ">
                                                            ...
                                                            <form:select id="ownershipList" class="form-control col-lg-7 required" required="true" path="ownershipList" name="contractor.ownershipTypeId">
                                            ...
                                            <div class="card hidden" id="cIncorporation">
                                                <div class="bg-blue card-status card-status-left"></div>
                                                <div class="card-header">
                                                    <h3 class="card-title">Attach Certificates of Incorporation/Sole Proprietorship (All documents issued by Company Registry Division, MoEA)</h3>
                                                </div>
                                                <div class="card-body">
                                                    <div class="col-lg-12">
                                            ...
                                            <div class="card" id="ownerPartner1">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="col-lg-12">
                                                            <h5 class="text-orange">Attach letter of Ownership change issued by DCRC(Family tree/MC).</h5>
                                        ...
                                        <div class="col-lg-12 form-group nextBackBtn">
                                            ...
                                            <button type="button" onclick="nextTab('generalInformation')"  id="btnValGINext" class="btn btn-primary nextTab">
                                                <i class="fa fa-arrow-circle-right"></i>Next &nbsp;
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="modal-body form-horizontal">
                                <div class="">
                                    <div class="form-group">
                                        ...
                                        <label class="col-lg-3">Registration Number :</label>
                                        <div class="col-lg-3">
