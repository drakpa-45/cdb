        ...
        <div class="panel-body" >
            ...
            <div class="form-group">
                ...
                <div class="col-lg-11">
                    ...
                    <p>2.&nbsp;&nbsp;&nbsp;Submit valid blue book copies supported by valid insurances for all RSTA registered equipments.</p>
                    <p>3.&nbsp;&nbsp;&nbsp;Submit equipments verification reports duly endorsed by a Govt. Engineer (not less than the rank of AE) for those equipment, which are not dealt by RSTA.</p>
                </div>
            </div>
            <div class="form-group">
                <div class="col-lg-6">
            ...
            <div class="modal-body form-horizontal">
                <div class = "">
                    <div class ="form-group">
                        ...
                        <div class = "col-lg-4">
                            <select name="equipments[0].equipmentId" class="form-control custom-select text-left select-beast equipmentId" required="" id="eq1">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="eqUploadTbl">
                                    ...
                                    <tr><td><input type='text' required="" class='form-control docName' name='equipments[0].contractorEQAs[0].documentName'/> </td>
                                        <td><input type='file' required="true" class='file' name='equipments[0].contractorEQAs[0].attachment' accept='application/msword,application/pdf,application/vnd.ms-excel,image/gif, image/jpeg, image/jpg,application/vnd.openxmlformats-officedocument.wordprocessingml.document'/> </td>
