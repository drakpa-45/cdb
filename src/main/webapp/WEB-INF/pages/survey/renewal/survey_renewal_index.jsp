            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card" id="registrtaionFormCard">
                        <form action="#" id="surveyrenewalForm" method="post" enctype="multipart/form-data">
                            <div class="card-header">
                                <h3 class="card-title font-weight-bold">Renewal of Survey</h3>
                                        ...
                                        <div class="nav-tabs-custom">
                                            ...
                                            <div class="tab-content border p-3 col-lg-12">
                                                <div class="tab-pane active feesStructurerenewal" id="feesStructure">
                                                  ...
                                                  <%--  <c:if test='${not empty renewalCheck.updateStatus}'>
                                                        <div class="form-group">
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 alert alert-danger text-center">
                                                                You have ongoing application with reference number: <b>${renewalCheck.referenceNo}</b> submitted on ${renewalCheck.applicationDate}. This application is <b>${renewalCheck.updateStatus}</b>. Please wait until complete process for this application.
                                                                <% nextbtn ="false1";%>
                                                            </div>
                                                        </div>
                                                    </c:if>--%>
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                                                        <input type="file" name="files" id="file1" class="alert badge-danger"  accept="application/msword,application/pdf,application/vnd.ms-excel,image/gif, image/jpeg, image/jpg,application/vnd.openxmlformats-officedocument.wordprocessingml.document" onchange="validateAttachment(this.value,'file1','filecheck1')">
                                                                    </div>
