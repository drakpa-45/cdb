                                        ...
                                        <div class="tab-content border p-3 col-lg-12">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                                            <input type="hidden" readonly
                                                                                   ...
                                                                                   class="form-control number">${appDetails.salutation}
                                                                            <span id="salutation_err"
                                                                                  class="text-danger"></span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label class="col-lg-4 col-md-4 col-sm-4 col-xs-12">Cid
                                                                            No:</label>

                                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                                            <input type="hidden" readonly id="cidNo"
                                                                                   value="${appDetails.cidNo}"
                                                                                   name="cidNo"
                                                                                   class="form-control number">${appDetails.cidNo}
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                                            <input type="hidden" readonly
                                                                                   ...
                                                                                   class="form-control">${appDetails.fullname}
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                                            <input type="hidden" readonly
                                                                                   value="${appDetails.dzongkhagId}"
                                                                                   maxlength="100" id="dzongkhag"
                                                                                   class="form-control">${appDetails.dzongkhagId}
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                                            <input type="hidden"
                                                                                   value="${appDetails.gewog}" readonly
                                                                                   maxlength="100" id="gewog"
                                                                                   name="gewog"
                                                                                   class="form-control">${appDetails.gewog}
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                                            <input type="hidden"
                                                                                   value="${appDetails.village}"
                                                                                   readonly maxlength="100" id="village"
                                                                                   name="village"
                                                                                   class="form-control">${appDetails.village}
                                                                            <input type="hidden" name="villageId"
                                                                                   id="villageId">
                                                                        </div>
                                                                    </div>
                                                                    <input type='button' value='Check for this CID'
                                                                           class='checkCid btn btn-success'>
                                                                </div>
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                                                                    <img src='https://www.citizenservices.gov.bt/BtImgWS/ImageServlet?type=PH&cidNo=${appDetails.cidNo}'
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                                                                    ...
                                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                        <input type="hidden"
                                                                               value="030ace8e-24af-11e6-967f-9c2a70cc8e06"
                                                                ...
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                                                                    ...
                                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                        <input type="hidden"
                                                                               value="${appDetails.countryId}" readonly
                                                                               maxlength="100" id="country"
                                                                               name="country"
                                                                               class="form-control">${appDetails.countryId}
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12">
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                                                                    ...
                                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                        <input type="hidden"
                                                                               value="${appDetails.serviceSectorType}"
                                                                               readonly maxlength="100" id="service"
                                                                               name="serviceSectorType"
                                                                               class="form-control">${appDetails.serviceSectorType}
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                                                                    ...
                                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                        <input type="hidden" value="${appDetails.trade}"
                                                                               readonly maxlength="100" id="service"
                                                                               name="trade"
                                                                               class="form-control">${appDetails.trade}
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="tab-pane categoryDtls" id="contact_detail">
                                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 form-group">
                                                            ...
                                                            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                                                                    ...
                                                                    <input id="email" type="hidden"
                                                                           value="${appDetails.email}" readonly
                                                                           class="form-control" name="email"
                                                                           placeholder="Type valid email">${appDetails.email}
                                                                </div>
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                                                                    <label>Mobile No:</label>
                                                                    <input type="hidden" class=" form-control number"
                                                                           value="${appDetails.mobileNo}" readonly
                                                                           id="mobileNo" name="mobileNo"
                                                                           maxlength="8">${appDetails.mobileNo}
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12">
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                                                                    ...
                                                                    <input type="hidden" class="form-control"
                                                                           value="${appDetails.employeeName}" readonly
                                                                           name="employeeName"
                                                                           placeholder="Employer Name">${appDetails.employeeName}
                                                                </div>
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                                                                    <label>Office/Employer Address:</label>
                                                                    <input type="hidden" class="form-control"
                                                                           value="${appDetails.employeeAddress}"
                                                                           readonly name="employeeAddress"
                                                                           placeholder="Employer Address">${appDetails.employeeAddress}
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                                                                    ...
                                                                    <input type="hidden" class=" form-control number"
                                                                           value="${appDetails.qualificationId}"
                                                                           readonly
                                                                           name="ualification">${appDetails.qualificationId}
                                                                </div>
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                                                                    <label>Year of Graduation:</label>
                                                                    <input type="hidden" class=" form-control number"
                                                                           value="${fn:substring(appDetails.graduationyr, 0, 4)}"
                                                                           readonly
                                                                           name="graduationYear">${fn:substring(appDetails.graduationyr, 0, 4)}
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                                                                    ...
                                                                    <input type="hidden" class="form-control "
                                                                           name="universityName"
                                                                           value="${appDetails.universityName}"
                                                                           readonly>${appDetails.universityName}
                                                                </div>
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                                                                    <label>Country of University:</label>
                                                                    <input type="hidden" class=" form-control number"
                                                                           value="${appDetails.universityCountry}"
                                                                           readonly
                                                                           name="universityCountry">${appDetails.universityCountry}
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row pull-right">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                                            <button type="button"
                                                                    onclick="previousTab('personalInformation','categoryDtls')"
                                            ...
                                            <div class="tab-pane saveAndPreview" id="saveAndPreview">
                                                <div id="submitSection" style="">
                                                    <div class="panel panel-default">
                                                        <div class="panel-body">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <button class="btn btn-primary"
                                                                                                type="button"
                                                                                                onclick="viewAttachment('${att.id}','view')"
                                                                                                target="_blank"><i
                                                                                                class="fa fa-eye"></i>
                                                                                            View
                                                                                        </button>
                                                                                    ...
                                                                                    <td>
                                                                                        <button class="btn btn-primary"
                                                                                                type="button"
                                                                                                onclick="viewAttachment('${att.id}','download')">
                                                            ...
                                                            <input type="hidden" class=" form-control number"
                                                                   value="${appDetails.cdbNo}" readonly name="cdbNo">
                                                                        ...
                                                                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                                                                                ...
                                                                                <input type="text"
                                                                                       ...
                                                                                       value="${appDetails.cdbNo}"
                                                                                       readonly name="cdbNotodisplay">
                                                                            </div>
                                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                                                                                <label>Payment Receipt Date:</label>
                                                                                <input type="text"
                                                                                       onclick="remove_err('paymentReceiptDate_err')"
                                                                                       class=" form-control datepicker"
                                                                                       readonly
                                                                                       name="paymentReceiptDate"
                                                                                       id="paymentReceiptDate">
                                                                                <span id="paymentReceiptDate_err"
                                                                                      class="text-danger"></span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                                                                                ...
                                                                                <input type="text"
                                                                                       onclick="remove_err('paymentReceiptNo_err')"
                                                                                       class="form-control "
                                                                                       name="paymentReceiptNo"
                                                                                       id="paymentReceiptNo">
                                                                                <span id="paymentReceiptNo_err"
                                                                                      class="text-danger"></span>
                                                                            </div>
                                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                                                                        ...
                                                                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                                                                                ...
                                                                                <select class="form-control"
                                                                                        onclick="remove_err('paymentmode_err')"
                                                                                        name="paymentmode"
                                                                                        id="paymentmode">
                                                                                    <option value="">Select</option>
                                                                                    <option value="CDB">CDB Cash
                                                                                    </option>
                                                                                    <option value="RRCO Thimphu">RRCO
                                                                                        Thimphu
                                                                                    </option>
                                                                                    <option value="RRCO Phuntsholing">
                                                                                        RRCO Phuntsholing
                                                                                    </option>
                                                                                    <option value="RRCO Gelephu">RRCO
                                                                                        Gelephu
                                                                                    </option>
                                                                                    <option value="RRCO Mongar">RRCO
                                                                                        Mongar
                                                                                    </option>
                                                                                    <option value="RRCO Samtse">RRCO
                                                                                        Samtse
                                                                                    </option>
                                                                                    <option value="RRCO Samdrupjongkhar">
                                                                                        RRCO Samdrupjongkhar
                                                                                    </option>
                                                                                    <option value="RRCO Bumthang">RRCO
                                                                                        Bumthang
                                                                                    </option>
                                                                                    <option value="RRCO Paro">RRCO
                                                                                        Paro
                                                                                    </option>
                                                                                </select>
                                                                                <span id="paymentmode_err"
                                                                                      class="text-danger"></span>
                                                                            </div>
                                                                ...
                                                                <div class="table-responsive">
                                                                    <c:if test="${appDetails.updateStatus=='36f9627a-adbd-11e4-99d7-080027dcfac6' || appDetails.updateStatus=='262a3f11-adbd-11e4-99d7-080027dcfac6'}">
                                                                        <table class="table">
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="2"
                                                                                    class="font-blue-madison bold warning">
                                                                                    Applicant Details
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    <table class="table table-condensed">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td><strong>Submitted
                                                                                                By: </strong></td>
                                                                                            <td>${appDetails.createdBy}<b
                                                                                                    style="color: blueviolet;">(${appDetails.fullname})</b>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                            ...
                                                            <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                                                ...
                                                                <textarea class="form-control"
                                                                          onclick="remove_err('remarks_err')"
                                                ...
                                                <div class="form-group row pull-right">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                                        <button type="button"
                                                                onclick="previousTab('categoryDtls','saveAndPreview')"
                                                                class="btn btn-success">
                                                            <i class="fa fa-arrow-circle-left"></i> Previous
                                                        </button>
                                                        <button class="btn btn-warning" type="button"
                                                                id="showrejectsection" onclick="updateReject()"><span
                                                                class="fa fa-times"></span> Reject
                                                        </button>
                                                        <c:if test="${appDetails.updateStatus=='262a3f11-adbd-11e4-99d7-080027dcfac6'}">
                                                            <button type="button" onclick="verifyApplication()"
                                                                    class="btn btn-primary">
                                                        ...
                                                        <c:if test="${appDetails.updateStatus=='36f9627a-adbd-11e4-99d7-080027dcfac6'}">
                                                            <button type="button"
                                                                    onclick="approveApplication('registration')"
                                                                    class="btn btn-primary">
                                                        ...
                                                        <c:if test="${appDetails.updateStatus=='6195664d-c3c5-11e4-af9f-080027dcfac6'}">
                                                            <button type="button"
                                                                    onclick="approveAndGenerateCertificate('registration')"
                                                                    class="btn btn-primary">
                                                                <i class="fa fa-save"></i> Approve & Generate
                                                                Certificate
                                                            </button>
                                                        </c:if>
                                                    </div>
                        ...
                        <div class="modal-dialog" style=" max-width: 900px;">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 id="myModalLabel" class="modal-title"><i class="fa fa-info-circle fa-lg"></i>
                                        Personal
                                        ...
                                        <div class="panel-body">
                                            <div id="modal-print">
                                                <div class="form-group">
                                                    ...
                                                    <p align="center"><strong>An surveyor is allowed to execute only two
                                                        work at
                                                        a time for that particular firm.</strong></p>

                                                    <p align="center"><strong>For any other Human Resource they are
                                                        allowed to
                                                ...
                                                <div class="form-group">
                                                    <div class="col-lg-12" align="center">
                                                        <p><span id="dcbinfo"><b>Human Resource is not registered in any
                                                            of the
                                                ...
                                                <div class="form-group">
                                                    <p align="center">With regard to Corporate Employee please verify
                                                        with the
                                                        concern agencies. There may be certain inconsistency.</p>
                                                    <hr>
                                                    <p align="center"><strong>Print this page as an evidence to prove
                                                        that
                                                        particular HR is engaged or not in a work or project</strong>
                                                    </p>
