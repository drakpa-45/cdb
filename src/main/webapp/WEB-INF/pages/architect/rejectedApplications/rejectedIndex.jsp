                                                                        ...
                                                                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                                                                                ...
                                                                                <select class="form-control" onclick="remove_err('paymentmode_err')" name="paymentmode" id="paymentmode">
                                                                                    ...
                                                                                    <option value="RRCO Gelephu">RRCOGelephu</option><option value="RRCO Mongar">RRCOMongar</option>
                                        ...
                                        <div class="panel-body">
                                            <div id="modal-print">
                                                <div class="form-group">
                                                    ...
                                                    <p align="center"><font size="5px;">Details of CID Number: <span id="cidchecked"></span></font></p>
                                                </div>
                                                <div class="form-group">
