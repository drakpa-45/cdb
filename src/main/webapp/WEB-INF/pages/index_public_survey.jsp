                            ...
                            <div class="table-responsive">
                                <table class="card-table table table-bordered table-vcenter" id="rejectedTblId">
                                    ...
                                    <c:forEach items="${rejectedApplications}" var="history" varStatus="i">
                                        <tr>
                                            <td>${i.index+1}</td>
                                            <td><a href="<c:url value="/public_access/emptylayout/surveyopenRejectedApplication?appNo="/>${history.applicationNo}" onclick="openAndClaimRejectedApplication2('${history.applicationNo}')"
