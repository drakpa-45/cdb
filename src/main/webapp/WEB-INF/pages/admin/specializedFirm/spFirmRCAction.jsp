                                ...
                                <div class="card tab2">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="col-lg-10 col-md-10 form-group">
                                            <label class="col-lg-4 form-label">Ownership Change Remarks: </label>
                                            <label class="col-lg-8 form-label form-control" id="ownershipChangeRemarks"></label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="modal-print-equipment">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        ...
                                        <p align="center"></p>
                                        <p align="center"><strong><span id="engagementStatus"></span></strong></p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <p align="center"><strong>Print this page as an evidence to prove that
