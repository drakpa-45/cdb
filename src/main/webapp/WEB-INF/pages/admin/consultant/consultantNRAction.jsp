                            ...
                            <div class="tab-content border p-3 col-lg-12">
                                <div class="tab-pane generalInformation active">
                                    ...
                                    <div class="col-lg-12 form-group">
                                        ...
                                        <button type="button"  onclick="nextTab('generalInformation','categoryDtls')" class="btn btn-primary" disabled id="nextGIBtn">
                                ...
                                <div class="tab-pane categoryDtls">
                                    ...
                                    <div class="col-lg-12 form-group">
                                        <button type="button" onclick="backTab('categoryDtls','generalInformation')" class="btn btn-azure col-lg-offset-9" id="btn2">
                                            <i class="fa fa-arrow-circle-left"></i>Back
                                        </button>
                                        <button type="button" onclick="nextTab('categoryDtls','humanResourceCriteria')" class="btn btn-primary" id="btn3">
                                            <i class="fa fa-arrow-circle-right"></i>Next
                                        </button>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-12 form-group">
                                        ...
                                        <div class="tab-pane consultantEquipmentDtls">
                                            ...
                                            <div class="col-lg-12 form-group">
                                                ...
                                                <button type="button"  class="btn btn-primary" disabled id="btnValEqNext" onclick="saveAndPreview('consultantEquipmentDtls', 'saveAndPreview')">Save & Preview &nbsp;
