...
<script>
    ...
    function openAndClaimApplication(appNo,type,cmnServiceTypeId){
        ...
        var url= '${pageContext.request.contextPath}/admin_architect/emptylayout/openApplication?appNo='+appNo+'&type='+type+'&cmnServiceType='+cmnServiceType;
