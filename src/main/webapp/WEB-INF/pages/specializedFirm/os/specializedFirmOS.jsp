...
<c:if test="${not empty res.status}">
    <div class="card" id="acknowledgment">
        <div class="card-header">
            <b>Specialized Firm >> Other Services >> </b>Acknowledgement
        </div>
        <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    <c:if test="${renewalCheck.status eq 1}">
                        <div class="col-md-12 col-lg-12">
                            ...
                            <form action="" method="post" class="" id="specializedFirmOSForm" enctype="multipart/form-data">
                                    ...
                                    <div class="tab-content border p-3 col-lg-12">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <table class="table table-bordered table-condensed table-striped">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Fees will be applied as per fee structure.</td>
                                                        </tr>
                                                        <tr>
                                        ...
                                        <div class="tab-pane generalInformation">
                                            <div class="div-actual">
                                                <div class="card" id="gInfo">
                                                    ...
                                                    <div class="card-body">
                                                        <input type="hidden" id="specializedFirmIdFinal">
                                                        <div class="form-group row">
                                                ...
                                                <div class="card tab2">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group row">
                                                            <div class="col-lg-6 col-md-6 ">
                                                                <label class="col-lg-4 form-label" for="estAddress">Establishment Address <span
                                        ...
                                        <div class="tab-pane category_details hide">
                                            ...
                                            <div class="col-lg-12 form-group nextBackBtn">
                                                <button type="button" id="btn4" onclick="backTab('category_details')" class="btn btn-azure col-lg-offset-9">
                                                    <i class="fa fa-arrow-circle-left"></i> &nbsp; Back
                                                </button>
                                        ...
                                        <div class="tab-pane human_resource_criteria hide">
                                            ...
                                            <div class="col-lg-12 form-group nextBackBtn">
                                                <button type="button" id="btn5" onclick="backTab('human_resource_criteria')" class="btn btn-azure col-lg-offset-9 backTab">
                                                    <i class="fa fa-arrow-circle-left"></i> &nbsp;Back
                                                </button>
                            ...
                            <div class="modal-dialog modal-lg" id="ownerModal">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body form-horizontal">
                                        <div class="modal-div">
                                            <div class="form-group">
                                                <input type="hidden" id="id5Edit" name="spFirmOWs[0].id">
                                                <label class="col-lg-2">Nationality
                                                    <span class="text-danger">*</span>:</label>
                                                <div class="col-lg-4">
...
<script type="text/javascript" src="<c:url value="/resources/js/cdb/specializedFirm/specializedFirmOS.js"/>"></script>
</body>
</html>