                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-6 col-md-6 ">
                                                                ...
                                                                <form:select id="ownershipList" class="form-control col-lg-7"
                                                                             required="true" path="ownershipList" name="specializedFirm.ownershipTypeId">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <table class="table table-bordered table-center table-responsive-lg"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" name="specializedFirm.spFirmHRs[0].cidNo" class="form-control hr-cid"
                                                                               placeholder="Text..">
                                                                    </td>
                                                                    <td>
                                                                        <form:select id="salutation" name="specializedFirm.spFirmHRs[0].salutationId"
                                                                    ...
                                                                    <td>
                                                                        <input type="text" class="form-control name" name="specializedFirm.spFirmHRs[0].name"
                                                                               placeholder="Text..">
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <form:select id="designation" name="specializedFirm.spFirmHRs[0].designationId"
                                                                                     class="form-control input-sm"
                                                                    ...
                                                                    <td>
                                                                        <label class="custom-control custom-checkbox ml-6">
                                                                            <input type="checkbox" class="custom-control-input showCert"
                                                                                   name="specializedFirm.spFirmHRs[0].siCertificate" value="1">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-6 col-md-6">
                                                                ...
                                                                <input type="email" class=" form-control col-lg-7"
                                                                       name="specializedFirm.regEmail" id="regEmail" required="true"
                                                                       placeholder="Text..">
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 ">
                                                                ...
                                                                <input type="text" class=" form-control col-lg-7"
                                                                       name="specializedFirm.regMobileNo" id="regMobileNo" required="true"
                                                                       placeholder="Text..">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                    ...
                                                    <tr>
                                                        <td><input type="hidden" class="hraId">
                                                            <input type='text' required="" value="Others"
                                                                   class='form-control docName'
                                                                   name='spFirmHRs[0].spFirmHRs[0].documentName'/>
                                                        </td>
                                                        <td><input type='file' required="" class='file'
                                                                   name='spFirmHRs[0].spFirmHRs[0].attachment'
                                                                   accept='application/msword,application/pdf,application/vnd.ms-excel,image/gif, image/jpeg, image/jpg,application/vnd.openxmlformats-officedocument.wordprocessingml.document'/>
                                                        </td>
                                                        <td class='file-size'></td>
                                                        <td class='del_row'><a class='p-2'><i
