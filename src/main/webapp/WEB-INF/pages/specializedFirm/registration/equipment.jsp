...
<div class="div-actual">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="table-responsive">
                        <table id="" class="table table-bordered table-hover" style=" font-size: 12px;">
                            ...
                            <tr>
                                <td>Submit blue book copies supported by Route Permits and insurances for all RSTA registered equipments.
                                </td>
                            </tr>
                            <tr>
                                <td>Submit equipments verification reports duly endorsed by a Govt. Engineer (not less than the rank of AE) for those equipment, which are not dealt by RSTA.
                                </td>
                            </tr>
                            </tbody>
                        </table>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="eqdatatable">
                    <thead>
                    <tr>
