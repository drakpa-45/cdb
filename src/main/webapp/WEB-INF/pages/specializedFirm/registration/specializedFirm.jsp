        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                ...
                <div class="card" id="registrtaionFormCard">
                                                                ...
                                                                <div id="termsAndCon">
                                                                    <ul>
                                                                        ...
                                                                        <li>I am/We are aware that any false information
                                                                            ...
                                                                            I/We shall not make refund claims of
                                                                            expenditure incurred in processing this
                                                                            application.
                                                                        </li>
                                                                        <li>I/We have read and understood the
                                                                            Guidelines, Codes and other legal instrument
                                                                            issued by CDB and shall perform in line with
                                                                            these instruments and any other laws in
                                                                            force. Failure to comply will be subject to
                                                                            the penalties provided for in instruments
                                                                            and applicable laws in force; and
                                                                        </li>
                    ...
                    <script src="<c:url value="/resources/js/cdb/specializedFirm/specializedFirm.js"/>"></script>
                </div>
            </div>
        </div>
    </div>
