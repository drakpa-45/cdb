                ...
                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-lg-12 col-md-12 col-sm-12 text-center">
                            <span class="error" id="err-expired-audit-memo" style="color:#ff0000; font-size: 18px"></span>
                        </div>
                    </div>
                    <c:if test="${renewalCheck.status eq 0}">
                        <div class="form-group row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 alert alert-danger text-center" style="font-size: 20px">
                                    ...
                                    <div class="tab-content border p-3 col-lg-12">
                                        ...
                                        <div class="tab-pane generalInformation">
                                            <div class="div-actual">
                                                ...
                                                <div class="card hidden" id="cFirmName">
                                                    <div class="bg-blue card-status card-status-left"></div>
                                                    <div class="card-header">
                                                        <h3 class="card-title">Attach Advertisement for firm name change</h3>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="col-lg-12">
                                                            <div class=""><input id="addMoreCertFirmName" type="button" value="Attachments" class="btn btn-primary"><span class="fa fa-hand-o-left pl-3 text-danger">Click here to add attachments</span></div>
                                                            <table class="table table-bordered table-center table-responsive-lg" id="certificateFirmNameTbl">
                                                                <thead>
                                                                <tr>
                                                                    <th>Sl no</th>
                                                                    <th>Document Name</th>
                                                ...
                                                <div class="card hidden" id="cIncorporation">
                                                    <div class="bg-blue card-status card-status-left"></div>
                                                    <div class="card-header">
                                                        <h3 class="card-title">Attach Certificates of Incorporation/Sole Proprietorship (All documents issued by Registry of Company, MoEA)</h3>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="col-lg-12">
                                                            <div class=""><input id="addMoreCert" type="button" value="Attachments" class="btn btn-primary"><span class="fa fa-hand-o-left pl-3 text-danger">Click here to add attachments</span></div>
                                                ...
                                                <div class="card" id="ownerPartner1">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="col-lg-12">
                                                                <span><h6 class="text-orange">Attach letter of Ownership change issued by DCRC(Family tree/MC).</h6></span>
                                                                <div class=""><input id="addMoreCertOwner" type="button" value="Attachments" class="btn btn-primary"><span class="fa fa-hand-o-left pl-3 text-danger">Click here to add attachments</span></div>
                                        ...
                                        <div class="tab-pane category_details hide">
                                            <div class="div-actual">
                                                ...
                                                <table id="contractorCCTbl" class="table table-bordered table-hover">
                                                    ...
                                                    <tr id="W4">
                                                        ...
                                                        <td><input type="hidden" name="categories[3].existingClassID" class="existingClassID" disabled>
                                                            <select class="form-control existingClassID" disabled="">
                                                                <option value="">-Select-</option>
                                                                <option value="e19afe94-c3ea-11e4-af9f-080027dcfac6">L:Large</option>
                                                                <option value="003f9a02-c3eb-11e4-af9f-080027dcfac6">M:Medium</option>
                                                        ...
                                                        <td><select name="categories[3].appliedClassID" class="form-control appliedClassID">
                                                            <option value="">-Select-</option>
                                                            <option value="e19afe94-c3ea-11e4-af9f-080027dcfac6">L:Large</option>
                                                            <option value="003f9a02-c3eb-11e4-af9f-080027dcfac6">M:Medium</option>
                                                            <option value="ef832830-c3ea-11e4-af9f-080027dcfac6">S:Small</option>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <br/>
                                                    <input type="button" id="addMoreCertCategory" value="Attachments" class="btn btn-primary eqFile"><span class="fa fa-hand-o-left pl-3 text-danger">Click here to add attachments</span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="input-group margin-bottom-sm">
                                                ...
                                                <input type="date" name="contractorHRs[0].joiningDate" id="hr10" class="form-control datepicker">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2">CDB Number:</label>
                                        <div class="col-lg-4">
                                            <div class="input-icon">
                                                <span class="input-icon-addon"><i class="fe fe-user"></i></span>
