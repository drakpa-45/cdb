                    ...
                    <tr>
                        ...
                        <td>
                            <label class="custom-control custom-checkbox ml-6">
                                <input type="checkbox" class="custom-control-input showCert" id="siCertificate" name="consultant.consultantHRs[0].siCertificate" value="1">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                <div class="col-lg-6 col-md-6">
                    ...
                    <input type="email" class=" form-control col-lg-7" name="consultant.regEmail" id="regEmail" required="true" placeholder="Email....">
                </div>
                <div class="col-lg-6 col-md-6">
                    <label class="col-lg-4 form-label">Confirm Email <span class="text-danger">*</span></label>
                    <input type="email" class=" form-control col-lg-7" name="consultant.confirmEmail" id="confirmEmail" required="true" placeholder="Confirm Email address">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-lg-6 col-md-6 ">
                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    <input type="text" class="form-control col-lg-7 number" name="consultant.regPhoneNo" id="regPhoneNo" placeholder="Telephone No..">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-lg-6 col-md-6">
                    <label class="col-lg-4 form-label">Fax No</label>
                    <input type="text" class=" form-control col-lg-7 number" name="consultant.regFaxNo" placeholder="Fax No..">
                </div>
            </div>
        </div>
    </div>
