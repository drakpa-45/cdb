...
<c:if test="${not empty res.status}">
    <div class="card" id="acknowledgment">
        <div class="card-header">
            <b>Consultant >> Cancellation of Certificate >> </b>Acknowledgement
        </div>
        <div class="card-body">
...
<c:if test="${empty res.status}">
    <div class="mt-5">
        <div class="container mb-9">
            <div class="card" id="registrtaionFormCard">
                <div class="card-header">
                    <h3 class="card-title font-weight-bold">Consultant >> Cancellation of Certificate >> CDB No : ${cdbNo}</h3>
                </div>
    ...
    <c:if test="${renewalCheck.status eq 1}">
        <p class="text-justify">
            <span id="message">Please provide your cancellation reason in a given text area.</span>
        </p>
                <form method="post" class="card-body" id="consultantCCForm" >
...
<script type="text/javascript" src="<c:url value="/resources/js/cdb/consultant/consultantCC.js"/>"></script>
