                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-6 col-lg-6">
                                                                ...
                                                                <input type="text" class="col-lg-7 form-control" id="firmName"
                                                                       name="consultant.firmName" required="true" placeholder="Text..">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-lg-6 col-md-6">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <table class="table table-bordered table-center table-responsive-lg"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" name="consultant.consultantHRs[0].cidNo" class="form-control hr-cid"
                                                                               placeholder="Text..">
                                                                    </td>
                                                                    <td>
                                                                        <form:select id="salutation" name="consultant.consultantHRs[0].salutationId"
                                                                    ...
                                                                    <td>
                                                                        <input type="text" class="form-control name" name="consultant.consultantHRs[0].name"
                                                                               placeholder="Text..">
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <form:select id="designation" name="consultant.consultantHRs[0].designationId"
                                                                                     class="form-control input-sm"
                                                                    ...
                                                                    <td>
                                                                        <label class="custom-control custom-checkbox ml-6">
                                                                            <input type="checkbox" class="custom-control-input showCert"
                                                                                   name="consultant.consultantHRs[0].siCertificate" value="1">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 ">
                                                                <label class="col-lg-4 form-label" for="estAddress">Establishment
                                                                    Address <span
                                                                            class="text-danger">*</span></label>
                                                                <input type="text" class="col-lg-7 form-control"
                                                                       name="consultant.estAddress" id="estAddress" required="true"
                                                                       placeholder="Text..">
                                                            </div>
                                                            <div class="col-lg-6 col-md-6">
                                                                ...
                                                                <form:select id="regDzongkhagId"
                                                                             ...
                                                                             path="dzongkhagList" name="consultant.regDzongkhagId">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-6 col-md-6">
                                                                ...
                                                                <input type="email" class=" form-control col-lg-7"
                                                                       name="consultant.regEmail" id="regEmail" required="true"
                                                                       placeholder="Text..">
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 ">
                                                                ...
                                                                <input type="text" class=" form-control col-lg-7"
                                                                       name="consultant.regMobileNo" id="regMobileNo" required="true"
                                                                       placeholder="Text..">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-lg-6 col-md-6">
                                                                ...
                                                                <input type="text" class="form-control col-lg-7"
                                                                       name="consultant.regPhoneNo" id="regPhoneNo"
                                                                       placeholder="Text..">
                                                            </div>
                                                            <div class="col-lg-6 col-md-6">
                                                                <label class="col-lg-4 form-label">Fax No </label>
                                                                <input type="text" class="form-control col-lg-7"
                                                                       name="consultant.regFaxNo" id="regFaxNo"
                                                                       placeholder="Text..">
                                                            </div>
                                                        </div>
                                                    </div>
