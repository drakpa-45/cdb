                ...
                <div class="card" id="registrtaionFormCard">
                    <form action="#" id="tradeverificationForm" >
                        ...
                        <input type="hidden" id="serviceSectorType" value="${appDetails.serviceTypeId}" name="serviceSectorType"/>
                            <div class="card-header">
                                <h3 class="card-title font-weight-bold" style="color: #002752">SpecializedTrade >> Registration >>
                                                ...
                                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 form-group">
                                                    <div class="card tab2">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                                                                    <label class="col-lg-4 col-md-4 col-sm-4 col-xs-12">Telephone Number:</label>
                                                                    <input id="tphone" type="hidden" value="${appDetails.telephoneNo}" readonly class="form-control" name="tphone">
                                                                    <label class="col-lg-8 form-label form-control">${appDetails.telephoneNo}</label>
                                                                </div>
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                                                                    <label class="col-lg-4 col-md-4 col-sm-4 col-xs-12">TPN Number:</label>
                                                                    <input type="hidden" class=" form-control number" value="${appDetails.tpn}" readonly id="tpn" name="tpn"  maxlength="8">
                                                                    <label class="col-lg-8 form-label form-control">${appDetails.tpn}</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                        ...
                                                                        <table id="attachment" class="table table-bordered table-hover">
                                                                            ...
                                                                            <c:forEach var="att" items="${appDetails.doc}" varStatus="counter">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td><button class="btn bg-yellow-light" type="button" onclick="viewAttachment('${att.id}','view','doc')" target="_blank"><i class="fa fa-eye"></i> View </button> </td>
                                                                                    <td><button class="btn bg-orange-light" type="button" onclick="viewAttachment('${att.id}','download','doc')"><i class="fa fa-download"></i> Download </button> </td>
                                                                                </tr>
                                                                            </c:forEach>
                                                                            </tbody>
                                                                        </table>
