                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                                                                    ...
                                                                    <input id="telephoneNo" type="email" value="${appDetails.telephoneNo}" readonly class="form-control" name="telephoneNo" placeholder="provide your telephone number">
                                                                </div>
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
                                                                    <label>TPN No:</label>
                                                                    <input type="text" class=" form-control number" value="${appDetails.tpn}" readonly id="tpn" name="tpn">
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12">
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
